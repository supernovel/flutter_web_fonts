...
class WebFontsVariant {
  ...
  /// Creates a [WebFontsVariant] from a Google Fonts API specific
  /// filename part.
  ///
  ...
  ///
  /// See [WebFontsVariant.toApiFilenamePart] for the inverse function.
  WebFontsVariant.fromApiFilenamePart(String filenamePart)
  ...
  WebFontsVariant.fromString(String variantString)
  ...
  /// Converts this [WebFontsVariant] to a Google Fonts API specific filename
  /// part.
  ///
  /// A Filename part is the part of the filename that does not include the
  /// font family. For example: for the filename "Lato-Regular.ttf", the
  /// filename part is "Regular".
  ///
  /// The following table shows how these [WebFontsVariant]s convert:
